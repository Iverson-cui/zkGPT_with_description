...
/**
 * This is the constructor of verifier.
 * @param pr Pointer to the prover instance.
 * @param cir Reference to the layeredCircuit instance.
 */
...
/**
 * This is the final prove function
 * In this function, GKR and Lasso is verified and at last commits are opened.
 * @param commit_thread Number of threads used in the commit opening phase.
 */
